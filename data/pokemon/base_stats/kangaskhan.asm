	...
	db COMET_PUNCH, THUNDERCLAP, NO_MOVE, NO_MOVE ; level 1 learnset
	...
	tmhm MEGA_PUNCH,   MEGA_KICK,    TOXIC,        BODY_SLAM,    TAKE_DOWN,    \
	     ...
	     THUNDERBOLT,  THUNDER,      EARTHQUAKE,   BOULDERCRASH,      MIMIC,        \
	     DOUBLE_TEAM,  BIDE,         FIRE_BLAST,   QUAD_PUNCH,   REST,         \
