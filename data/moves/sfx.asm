MoveSoundTable:
	...
	db SFX_BATTLE_0F,          $20, $40 ; BUG_STING
	db SFX_BATTLE_0F,          $00, $80 ; X_SCISSOR
	db SFX_BATTLE_0E,          $00, $a0 ; DUST_DEVIL
	...
	db SFX_BATTLE_14,          $00, $80 ; SCARY_FACE
	...
	db SFX_BATTLE_21,          $10, $80 ; SHADOW_PUNCH
	db SFX_BATTLE_1B,          $01, $a0 ; SAND_ATTACK
	db SFX_BATTLE_18,          $00, $80 ; TRIPLE_BITE
	db SFX_BATTLE_1E,          $00, $60 ; HORN_ATTACK
	db SFX_BATTLE_1E,          $01, $40 ; FURY_ATTACK
	db SFX_HORN_DRILL,         $00, $a0 ; WILL_O_WISP
	...
	db SFX_BATTLE_0B,          $00, $40 ; DRAGON_ROAR
	...
	db SFX_BATTLE_29,          $00, $80 ; POWDER_SNOW
	...
	db SFX_BATTLE_23,          $01, $c0 ; POISON_JAB
	db SFX_BATTLE_23,          $00, $80 ; LOW_KICK
	db SFX_SUPER_EFFECTIVE,    $00, $e0 ; FLAME_WHEEL
	...
	db SFX_BATTLE_29,          $11, $20 ; BOULDERCRASH
	...
	db SFX_BATTLE_26,          $f0, $20 ; THUNDERCLAP
	...
	db SFX_BATTLE_0E,          $f0, $10 ; IRON_DEFENSE
	db SFX_BATTLE_0F,          $f8, $10 ; HAZE
	db SFX_NOT_VERY_EFFECTIVE, $f0, $10 ; NATURALFORCE
	db SFX_BATTLE_25,          $00, $80 ; GIGA_DRAIN
	...
	db SFX_BATTLE_32,          $00, $80 ; EARTH_PUNCH
	db SFX_BATTLE_29,          $1f, $20 ; FIRE_BLAST
	db SFX_BATTLE_25,          $2f, $80 ; OUTRAGE
	db SFX_BATTLE_0F,          $1f, $ff ; POISON_FANG
	db SFX_BATTLE_2B,          $1f, $60 ; SWIFT
	db SFX_BATTLE_26,          $1e, $20 ; QUAD_PUNCH
	db SFX_BATTLE_26,          $1f, $18 ; DRAGONFIRE
	db SFX_BATTLE_14,          $0f, $80 ; SMOTHER
	db SFX_BATTLE_09,          $f8, $10 ; AMNESIA
	db SFX_FAINT_FALL,         $18, $20 ; FAKE_TEARS
	db SFX_BATTLE_32,          $08, $40 ; SOFTBOILED
	db SFX_BATTLE_17,          $01, $e0 ; HI_JUMP_KICK
	db SFX_NOT_VERY_EFFECTIVE, $09, $ff ; GLARE
	db SFX_BATTLE_35,          $42, $01 ; EXTRASENSORY
	...
	db SFX_BATTLE_0C,          $f0, $f0 ; ICY_WIND
	...
	db SFX_BATTLE_0E,          $f0, $20 ; SAND_RAKE
