...
; - MoveSoundTable (see data/moves/sfx.asm)
	...
	const MEGA_KICK    ; 19
	const JUMP_KICK    ; 1a
	const SHADOW_PUNCH ; 1b
	const SAND_ATTACK  ; 1c
	const TRIPLE_BITE  ; 1d
	const HORN_ATTACK  ; 1e
	const FURY_ATTACK  ; 1f
	const WILL_O_WISP  ; 20
	const TACKLE       ; 21
	const BODY_SLAM    ; 22
	const WRAP         ; 23
	const TAKE_DOWN    ; 24
	...
	const BARRIER      ; 70
	const IRON_DEFENSE ; 71
	const HAZE         ; 72
	const NATURALFORCE ; 73
	const GIGA_DRAIN   ; 74
	const BIDE         ; 75
	const METRONOME    ; 76
	const MIRROR_MOVE  ; 77
	const SELFDESTRUCT ; 78
	const SLUDGE_BOMB  ; 79
	const LICK         ; 7a
	const SHADOW_BALL  ; 7b
	const SLUDGE       ; 7c
	const EARTH_PUNCH  ; 7d
	const FIRE_BLAST   ; 7e
	const OUTRAGE      ; 7f
	const POISON_FANG  ; 80
	const SWIFT        ; 81
	const QUAD_PUNCH   ; 82
	const DRAGONFIRE   ; 83
	const SMOTHER      ; 84
